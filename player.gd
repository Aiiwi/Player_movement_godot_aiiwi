...
@export_group("Camera")
@export_range(0.1,1.0) var mouse_sensitivity :float = 0.2 #Sensibilty !!change this to reference a global var

@export_group("Player_Movement")
@export var move_speed :float = 5.0 #Player normal speed
@export var acceleration :float = 20.0

@onready var pause_ui:CanvasLayer= $CameraPoint/UI/Pause_UI as CanvasLayer
